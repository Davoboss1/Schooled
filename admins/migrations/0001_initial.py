...
from accounts.models import username_exists
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sender', models.CharField(max_length=30, null=True, validators=[username_exists])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sent_by', models.CharField(max_length=30, null=True, validators=[username_exists])),
